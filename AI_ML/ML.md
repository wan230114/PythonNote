...
* [1. 概述](#1-概述)
  ...
  * [1.2. 为什么需要机器学习](#12-为什么需要机器学习)
  * [1.3. 机器学习的问题](#13-机器学习的问题)
  * [1.4. 机器学习的种类](#14-机器学习的种类)
  * [1.5. 机器学习的一般过程](#15-机器学习的一般过程)
  * [1.6. 机器学习的典型应用](#16-机器学习的典型应用)
  * [1.7. 机器学习的基本问题](#17-机器学习的基本问题)
* [2. 数据预处理](#2-数据预处理)
  * [2.1. 均值移除(标准化)](#21-均值移除标准化)
  * [2.2. 范围缩放](#22-范围缩放)
  * [2.3. 归一化](#23-归一化)
  * [2.4. 二值化](#24-二值化)
  * [2.5. 独热编码](#25-独热编码)
...
* [3. 线性回归](#3-线性回归)
  * [3.1. 原理理解](#31-原理理解)
  * [3.2. 线性回归API](#32-线性回归api)
    * [3.2.1. 评估训练结果误差（metrics）](#321-评估训练结果误差metrics)
    * [3.2.2. 模型的保存和加载](#322-模型的保存和加载)
    * [3.2.3. 岭回归](#323-岭回归)
* [4. 多项式回归](#4-多项式回归)
* [5. 决策树](#5-决策树)
  * [概述](#概述)
...
* [10. 验证曲线](#10-验证曲线)
* [11. 学习曲线](#11-学习曲线)
* [12. 支持向量机(SVM)](#12-支持向量机svm)
  * [12.1. 支持向量机原理](#121-支持向量机原理)
  * [12.2. 样本类别均衡化](#122-样本类别均衡化)
  * [12.3. 置信概率](#123-置信概率)
  * [12.4. 网格搜索](#124-网格搜索)
* [13. 案例：事件预测](#13-案例事件预测)
* [14. 案例：交通流量预测(回归)](#14-案例交通流量预测回归)
* [15. 聚类](#15-聚类)
  * [15.1. K均值算法](#151-k均值算法)
  * [15.2. 图像量化](#152-图像量化)
  * [15.3. 均值漂移算法](#153-均值漂移算法)
  * [15.4. 凝聚层次算法](#154-凝聚层次算法)
* [16. 聚类](#16-聚类)
  * [16.1. 轮廓系数](#161-轮廓系数)
  * [16.2. DBSCAN算法](#162-dbscan算法)
* [17. 推荐引擎](#17-推荐引擎)
* [18. 自然语言处理（NLP）](#18-自然语言处理nlp)
  * [18.1. 文本分词](#181-文本分词)
  * [18.2. 词干提取](#182-词干提取)
  * [18.3. 词性还原](#183-词性还原)
  * [18.4. 词袋模型](#184-词袋模型)
  * [18.5. 词频（TF）](#185-词频tf)
  * [18.6. 文档频率（DF）](#186-文档频率df)
  * [18.7. 逆文档频率（IDF）](#187-逆文档频率idf)
  * [18.8. 词频-逆文档频率(TF-IDF)](#188-词频-逆文档频率tf-idf)
  * [18.9. 文本分类(主题识别)](#189-文本分类主题识别)
  * [18.10. 性别识别](#1810-性别识别)
* [19. 自然语言处理（NLP）](#19-自然语言处理nlp)
  * [19.1. nltk分类器](#191-nltk分类器)
  * [19.2. 情感分析](#192-情感分析)
  * [19.3. 主题抽取](#193-主题抽取)
* [20. 语音识别](#20-语音识别)
  * [20.1. 语音识别](#201-语音识别)
  * [20.2. 声音合成](#202-声音合成)
* [21. 图像识别](#21-图像识别)
  * [21.1. OpenCV基础](#211-opencv基础)
  * [21.2. 边缘检测](#212-边缘检测)
  * [21.3. 亮度提升](#213-亮度提升)
  * [21.4. 角点检测](#214-角点检测)
* [22. 图像识别](#22-图像识别)
  * [22.1. 特征点检测](#221-特征点检测)
  * [22.2. 特征值矩阵](#222-特征值矩阵)
  * [22.3. 物体识别](#223-物体识别)
* [23. 人脸识别](#23-人脸识别)
  * [23.1. 视频捕捉](#231-视频捕捉)
  * [23.2. 人脸定位](#232-人脸定位)
