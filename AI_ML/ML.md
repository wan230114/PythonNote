...
* [目录](#_目录)
* [1. 概述](#_1-概述)
  * [1.1. 什么是机器学习](#_11-什么是机器学习)
  * [1.2. 为什么需要机器学习](#_12-为什么需要机器学习)
  * [1.3. 机器学习的问题](#_13-机器学习的问题)
  * [1.4. 机器学习的种类](#_14-机器学习的种类)
  * [1.5. 机器学习的一般过程](#_15-机器学习的一般过程)
  * [1.6. 机器学习的典型应用](#_16-机器学习的典型应用)
  * [1.7. 机器学习的基本问题](#_17-机器学习的基本问题)
* [2. 数据预处理](#_2-数据预处理)
  * [2.1. 均值移除(标准化)](#_21-均值移除标准化)
  * [2.2. 范围缩放](#_22-范围缩放)
  * [2.3. 归一化](#_23-归一化)
  * [2.4. 二值化](#_24-二值化)
  * [2.5. 独热编码](#_25-独热编码)
...
* [3. 线性回归](#_3-线性回归)
  * [3.1. 原理理解](#_31-原理理解)
  * [3.2. 线性回归API](#_32-线性回归api)
    * [3.2.1. 评估训练结果误差（metrics）](#_321-评估训练结果误差metrics)
    * [3.2.2. 模型的保存和加载](#_322-模型的保存和加载)
    * [3.2.3. 岭回归](#_323-岭回归)
* [4. 多项式回归](#_4-多项式回归)
* [5. 决策树](#_5-决策树)
  * [5.1. 基本算法原理](#_51-基本算法原理)
  * [5.2. 工程优化](#_52-工程优化)
  * [5.3. 集合算法](#_53-集合算法)
    * [5.3.1. 正向激励](#_531-正向激励)
    * [5.3.2. 自助聚合](#_532-自助聚合)
    * [5.3.3. 随机森林](#_533-随机森林)
* [6. 人工分类](#_6-人工分类)
* [7. 逻辑分类](#_7-逻辑分类)
* [8. 朴素贝叶斯分类](#_8-朴素贝叶斯分类)
  * [8.1. 数据集划分](#_81-数据集划分)
  * [8.2. 交叉验证](#_82-交叉验证)
  * [8.3. 混淆矩阵](#_83-混淆矩阵)
  * [8.4. 分类报告](#_84-分类报告)
...
* [10. 验证曲线](#_10-验证曲线)
* [11. 学习曲线](#_11-学习曲线)
* [12. 支持向量机(SVM)](#_12-支持向量机svm)
  * [12.1. 支持向量机原理](#_121-支持向量机原理)
  * [12.2. 样本类别均衡化](#_122-样本类别均衡化)
  * [12.3. 置信概率](#_123-置信概率)
  * [12.4. 网格搜索](#_124-网格搜索)
* [13. 案例：事件预测](#_13-案例事件预测)
* [14. 案例：交通流量预测(回归)](#_14-案例交通流量预测回归)
* [15. 聚类](#_15-聚类)
  * [15.1. K均值算法](#_151-k均值算法)
  * [15.2. 图像量化](#_152-图像量化)
  * [15.3. 均值漂移算法](#_153-均值漂移算法)
  * [15.4. 凝聚层次算法](#_154-凝聚层次算法)
* [16. 聚类](#_16-聚类)
  * [16.1. 轮廓系数](#_161-轮廓系数)
  * [16.2. DBSCAN算法](#_162-dbscan算法)
* [17. 推荐引擎](#_17-推荐引擎)
* [18. 自然语言处理（NLP）](#_18-自然语言处理nlp)
  * [18.1. 文本分词](#_181-文本分词)
  * [18.2. 词干提取](#_182-词干提取)
  * [18.3. 词性还原](#_183-词性还原)
  * [18.4. 词袋模型](#_184-词袋模型)
  * [18.5. 词频（TF）](#_185-词频tf)
  * [18.6. 文档频率（DF）](#_186-文档频率df)
  * [18.7. 逆文档频率（IDF）](#_187-逆文档频率idf)
  * [18.8. 词频-逆文档频率(TF-IDF)](#_188-词频-逆文档频率tf-idf)
  * [18.9. 文本分类(主题识别)](#_189-文本分类主题识别)
  * [18.10. 性别识别](#_1810-性别识别)
* [19. 自然语言处理（NLP）](#_19-自然语言处理nlp)
  * [19.1. nltk分类器](#_191-nltk分类器)
  * [19.2. 情感分析](#_192-情感分析)
  * [19.3. 主题抽取](#_193-主题抽取)
* [20. 语音识别](#_20-语音识别)
  * [20.1. 语音识别](#_201-语音识别)
  * [20.2. 声音合成](#_202-声音合成)
* [21. 图像识别](#_21-图像识别)
  * [21.1. OpenCV基础](#_211-opencv基础)
  * [21.2. 边缘检测](#_212-边缘检测)
  * [21.3. 亮度提升](#_213-亮度提升)
  * [21.4. 角点检测](#_214-角点检测)
* [22. 图像识别](#_22-图像识别)
  * [22.1. 特征点检测](#_221-特征点检测)
  * [22.2. 特征值矩阵](#_222-特征值矩阵)
  * [22.3. 物体识别](#_223-物体识别)
* [23. 人脸识别](#_23-人脸识别)
  * [23.1. 视频捕捉](#_231-视频捕捉)
  * [23.2. 人脸定位](#_232-人脸定位)
...
# 23. n_components: 用几个高斯分布函数拟合样本数据
# 24. covariance_type: 相关矩阵的辅对角线进行相关性比较
# 25. n_iter: 最大迭代上限
model = hl.GaussianHMM(n_components=4, covariance_type='diag', n_iter=1000)
model.fit(mfccs)
# 26. 使用模型匹配测试mfcc矩阵的分值
...
```python
# 32. 索贝尔边缘识别
# 33. cv.CV_64F：卷积运算使用数据类型为64位浮点型（保证微分的精度）
# 34. 1：水平方向索贝尔偏微分
# 35. 0：垂直方向索贝尔偏微分
# 36. ksize：卷积核为5*5的方阵
...
gray = cv.cvtColor(original, cv.COLOR_BGR2GRAY)
# 43. Harris角点检测器
# 44. 边缘水平方向、垂直方向颜色值改变超过阈值7、5时即为边缘
# 45. 边缘线方向改变超过阈值0.04弧度即为一个角点。
...
# 48. drawKeypoints方法可以把所有的特征点绘制在mixture图像中
...
# 52. 遍历所有测试样本  使用model匹配测试样本查看每个模型的匹配分数
...
```python
import cv2 as cv
# 57. 通过特征描述文件构建哈尔级联人脸识别器
fd = cv.CascadeClassifier('../data/haar/face.xml')
# 58. 从一个图像中识别出所有的人脸区域
# 59. 1.3：为最小的人脸尺寸
# 60. 5：最多找5张脸
# 61. 返回：
# 62. faces: 抓取人脸（矩形区域）列表 [(l,t,w,h),(),()..]
