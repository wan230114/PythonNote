...
- [3. 线性回归](#3-线性回归)
  - [原理理解](#原理理解)
  - [4. 线性回归API](#4-线性回归api)
    - [4.1. 评估训练结果误差（metrics）](#41-评估训练结果误差metrics)
    - [4.2. 模型的保存和加载](#42-模型的保存和加载)
    - [4.3. 岭回归](#43-岭回归)
- [5. 多项式回归](#5-多项式回归)
- [6. 决策树](#6-决策树)
  - [6.1. 基本算法原理](#61-基本算法原理)
  - [6.2. 工程优化](#62-工程优化)
  - [6.3. 集合算法](#63-集合算法)
    - [6.3.1. 正向激励](#631-正向激励)
    - [6.3.2. 自助聚合](#632-自助聚合)
...
- [11. 验证曲线](#11-验证曲线)
- [12. 学习曲线](#12-学习曲线)
- [13. 支持向量机(SVM)](#13-支持向量机svm)
  - [13.1. 支持向量机原理](#131-支持向量机原理)
  - [13.2. 样本类别均衡化](#132-样本类别均衡化)
  - [13.3. 置信概率](#133-置信概率)
  - [13.4. 网格搜索](#134-网格搜索)
- [14. 案例：事件预测](#14-案例事件预测)
- [15. 案例：交通流量预测(回归)](#15-案例交通流量预测回归)
- [16. 聚类](#16-聚类)
  - [16.1. K均值算法](#161-k均值算法)
  - [16.2. 图像量化](#162-图像量化)
  - [16.3. 均值漂移算法](#163-均值漂移算法)
  - [16.4. 凝聚层次算法](#164-凝聚层次算法)
- [17. 聚类](#17-聚类)
  - [17.1. 轮廓系数](#171-轮廓系数)
  - [17.2. DBSCAN算法](#172-dbscan算法)
- [18. 推荐引擎](#18-推荐引擎)
- [19. 自然语言处理（NLP）](#19-自然语言处理nlp)
  ...
  - [19.4. 词袋模型](#194-词袋模型)
  - [19.5. 词频（TF）](#195-词频tf)
  - [19.6. 文档频率（DF）](#196-文档频率df)
  - [19.7. 逆文档频率（IDF）](#197-逆文档频率idf)
  - [19.8. 词频-逆文档频率(TF-IDF)](#198-词频-逆文档频率tf-idf)
  - [19.9. 文本分类(主题识别)](#199-文本分类主题识别)
  - [19.10. 性别识别](#1910-性别识别)
- [20. 自然语言处理（NLP）](#20-自然语言处理nlp)
  - [20.1. nltk分类器](#201-nltk分类器)
  - [20.2. 情感分析](#202-情感分析)
  - [20.3. 主题抽取](#203-主题抽取)
- [21. 语音识别](#21-语音识别)
  - [21.1. 语音识别](#211-语音识别)
  - [21.2. 声音合成](#212-声音合成)
- [22. 图像识别](#22-图像识别)
  - [22.1. OpenCV基础](#221-opencv基础)
  - [22.2. 边缘检测](#222-边缘检测)
  - [22.3. 亮度提升](#223-亮度提升)
  - [22.4. 角点检测](#224-角点检测)
- [23. 图像识别](#23-图像识别)
  - [23.1. 特征点检测](#231-特征点检测)
  - [23.2. 特征值矩阵](#232-特征值矩阵)
  - [23.3. 物体识别](#233-物体识别)
- [24. 人脸识别](#24-人脸识别)
  - [24.1. 视频捕捉](#241-视频捕捉)
  - [24.2. 人脸定位](#242-人脸定位)
