$docsify.plugins = [].concat(function (i) {
    ...
    i.afterEach(function (i) {
        return i + '<TABLE align=center background=http://image7.360doc.com/DownloadImg/2010/01/2405/2217239_7.gif border=0  style="background-size: 100%;"><TBODY><TR><TD style="FILTER: mask(color=#000000)" align=middle><FONT style="FONT-SIZE: 40pt" face=隶书 color=#FFFFDD><B> 广 告 位 - - > 招 租 </B></FONT></TD></TR></TBODY></TABLE>'
        // + '<iframe frameborder="5" width="'
        // + e.getNode("#main").clientWidth
        // + '" height="93"'
        // +'  frameborder="0" src="./.js/own/test_ad.html"></iframe>'
        // '<iframe src="./.js/own/test_ad.html" id="iframe" src="index.html" frameborder="0"  style="border: 0px;"></iframe>'
        // // + text1
        ...
        // + e.getNode("#main").clientWidth
        // + '" height="93"'
        // + ' id="google_ads_frame1" name="google_ads_frame1" sandbox="allow-forms allow-pointer-lock allow-popups allow-popups-to-escape-sandbox allow-same-origin allow-scripts allow-top-navigation-by-user-activation" frameborder="0"'
        // + ' src="https://googleads.g.doubleclick.net/pagead/ads?client=ca-pub-1076724771190722&amp;output=html&amp;h=103&amp;slotname=3967051353&amp;adk=959199999&amp;adf=1842464052&amp;w='
        // + e.getNode("#main").clientWidth
